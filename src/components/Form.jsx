const Form = () => {
  return (
    <section id="form-page">
      ...
      <form className="bg-white mx-auto text-black p-6 rounded-lg shadow-lg w-full max-w-lg">
        <fieldset className="mb-4">
          <legend className="text-2xl font-semibold mb-4">User Information</legend>
